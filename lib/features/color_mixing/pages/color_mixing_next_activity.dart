        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 82.w,),
                    SvgPicture.asset(AppImages.yellowColorLevelForMix,height: 157.77.h, width: 188.73.w,),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(image: AssetImage(AppImages.mixedColor,) )
                      ),
                      child: Center(child: SvgPicture.asset(AppImages.questionMark,width: 35,height: 62,)),
                    )
                  ],),
              ),
            ),
            ...
            Row(
              ...
              children: [
                SvgPicture.asset(AppImages.colorLevelGreen,width: 100.w,height: 92.68.h,),
                SizedBox(width: 41.w,),
                SvgPicture.asset(AppImages.dvider,width: 9.w,height: 40.h,),
                SizedBox(width: 41.w,),
                SvgPicture.asset(AppImages.colorLevelPurple, width: 100.w,height: 93.25.h,),
                SizedBox(width: 41.w,),
                SvgPicture.asset(AppImages.dvider,width: 9.w,height: 40.h,),
                SizedBox(width: 41.w,),
                SvgPicture.asset(AppImages.colorLevelYellow,width: 100.w,height: 92.68.h,)
              ],
            )
          ],
        ),
